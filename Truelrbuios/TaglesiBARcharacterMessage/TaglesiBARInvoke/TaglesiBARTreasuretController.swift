//
//  TaglesiBARTreasuretController.swift
//  Truelrbuios
//
...
class TaglesiBARTreasuretController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let spectralTask = DispatchWorkItem { [weak self] in
                   ...
                   self.dismiss(animated: true)
            TaglesiBARloPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("Q29ubmVjdCBmYWlsZWQsIHRoZSBvdGhlciBwYXJ0eSBoYXMgbGVmdGNvbS50cm1saW4udHJ1ZWxy"))
