...
class eventTrackerControoer: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
       let eventr = enentInfo[indexPath.row]
        ...
        let laiu = collectionView.dequeueReusableCell(withReuseIdentifier: "TaglesiBAREventtrackerCell", for: indexPath) as! TaglesiBAREventtrackerCell
   ...
   @objc func rpeouingtety(_ sender: UIButton) {
    ...
    private func visionBoard() {
        ...
        mangaPanel.register(UINib.init(nibName: "TaglesiBAREventtrackerCell", bundle: nil), forCellWithReuseIdentifier: "TaglesiBAREventtrackerCell")
