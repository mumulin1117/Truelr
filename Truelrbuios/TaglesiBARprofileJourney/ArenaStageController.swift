...
class ArenaStageController: UIViewController, painghur {
    ...
    private var cellModelFot:TaglesiBARTopicsCellModel?
    private var dymTyoe:Int?
    init(cellModelFot: TaglesiBARTopicsCellModel? = nil,dymTyoe:Int? = nil,nisertgeing:Dictionary<String,Any>) {
    ...
    private func visionBoard() {
        ...
        mangaPanel.register(UINib.init(nibName: "TaglesiBARrmalUserinfoCell", bundle: nil), forCellWithReuseIdentifier: "TaglesiBARrmalUserinfoCell")
    ...
    @objc func lijhngdycb(_ sender: Any) {//video
        let shipo = TaglesiBARTreasuretController.init(nisertgeing: nisertgeing,isfromamatching: false)
...
extension ArenaStageController:UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let conceptMap = collectionView.dequeueReusableCell(withReuseIdentifier: "TaglesiBARrmalUserinfoCell", for: indexPath) as!  TaglesiBARrmalUserinfoCell
...
extension ArenaStageController:UICollectionViewDelegate{
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(TaglesiBARAnovationLabControlle.init(cellModelFot: modalfe, dymTyoe: ding), animated: true)
        }
