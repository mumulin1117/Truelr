    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 2:
            ChronoEngine.executeAfterTemporalShift(2) {
                TaglesiBARloPulseIndicatar.showSuccess(withStatus:UIImageView.ambienceVaultDeu("Q2xlYXIgY29tcGxldGVkIWNvbS50cm1saW4udHJ1ZWxy") )
            }
        case 3:
            ...
            let confirm = UIAlertAction(title: UIImageView.ambienceVaultDeu("WWVzLCBEZWxldGVjb20udHJtbGluLnRydWVscg=="), style: .destructive) { _ in
                ...
                TaglesiBARTopicsCellModel.ExestedLogUserID = nil
                lensCraftController.changeinmge = UIImage.init(named: "Hildojd")!
                TaglesiBARSomiccon.CurrentCoinggUserOwne = 0
