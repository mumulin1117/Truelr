...
class QuestSeekerControlle: UIViewController ,UITextViewDelegate{
    ...
    @IBAction func dreamscapeHub(_ sender: UIButton) {
        ...
        guard postText.count > 0,postText != UIImageView.ambienceVaultDeu("ICBUZXh0IHNvbWV0aGluZy4uLmNvbS50cm1saW4udHJ1ZWxy")
            ...
            TaglesiBARloPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("QmVmb3JlIHBvc3QgLCBwbGVhc2UgZW50ZXIgc29tZXRoaW5nLmNvbS50cm1saW4udHJ1ZWxy"))
        ...
        guard let mediaURL = selectedMedia else {
            TaglesiBARloPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("UGxlYXNlIGFkZCBhbiBpbWFnZSBvciB2aWRlbyBiZWZvcmUgcG9zdGluZy5jb20udHJtbGluLnRydWVscg=="))
                    return
                }
    ...
    func villageSquare()  {
        ChronoEngine.executeAfterTemporalShift(1) {
            ...
            TaglesiBARloPulseIndicatar.showSuccess(withStatus: UIImageView.ambienceVaultDeu("U2VuZCBzdWNjZXNzZnVsLHlvdXIgcG9zdCB3aWxsIGJlIGRpc3BsYXllZCBhZnRlciBhcHByb3ZhbGNvbS50cm1saW4udHJ1ZWxy"))
